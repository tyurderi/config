module.exports = Class.extend(EventAbstract, {
    ...
    load: function()
    {
        ...
        EntityManager.loadConfig(me.configId).with('columns').submit(function(response) {
    ...
    {
        var me    = this,
            query = EntityManager.loadTableData(me.configId);

        query.with('orderBy', me.params.orderBy);
        query.with('order', me.params.order);
        query.with('filterBy', me.params.filterBy);
        query.with('limit', me.params.limit);
        query.with('offset', me.params.offset);
    ...
    processRow: function(row)
    {
        ...
        $remove.on('click', function() {
            ...
            {
                EntityManager.deleteTableData(me.configId, row.id).submit(function(response) {
                    if(response.success)
                    {
                        me.loadData();
                    }
