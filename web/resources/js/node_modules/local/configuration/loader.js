module.exports = Class.extend(EventAbstract, {
    ...
    constructor: function(configId)
    {
        ...
        me.url.load   = __url('config/load'); //me.$container.attr('data-loadUrl');
        me.url.fetch  = __url('config/fetch'); //me.$container.attr('data-fetchUrl');
        me.url.delete = __url('config/delete'); //me.$container.attr('data-deleteUrl');
    },
    /**
