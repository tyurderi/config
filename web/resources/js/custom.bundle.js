        ...
        $.get(url, data, function(response) {
            ...
            response.data.forEach(function(item) {
                ...
                $item.on('click', function() {
                    $configurationCount.children().removeClass('active');
...
module.exports = require('class-js2').create({
    ...
    constructor: function(configId)
    {
        ...
        me.url.delete = me.$container.attr('data-deleteUrl');
    },
    /**
    ...
    processRow: function(row)
    {
        ...
        $remove.on('click', function() {
            ...
            {
                $.get(me.url.delete, { id: me.configId, rowId: row.id }, function(response) {
                    if(response.success)
                    {
                        me.loadData();
                    }
